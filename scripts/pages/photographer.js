...
class PhotographerApp {
  ...
  static getInfosOfPhotographer(arrayOfUsers, urlIdOfPhotographer) {
    ...
    amountOfLikesParagraph.innerHTML = `${amountOfLikes} <i class="fa-solid fa-heart" aria-label="Liker le post" title="Liker ce post ?"></i>`;
  ...
  static getPostsOfPhotographer(arrayOfPosts, urlIdOfPhotographer) {
    ...
    photographersPostsArray =
      arrayOfPosts.filter((post) => post.photographerId === urlIdOfPhotographer);
  ...
  static updateProfile(dataObject, container) {
...
launchPhotographerApp.then((data) => {
  ...
  PhotographerApp.updateProfile(photographerObject, profileContainer);
